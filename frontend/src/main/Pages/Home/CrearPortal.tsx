...
import {
    ...
    Terminal,
    Globe,
    Lock, // <-- Agregamos íconos para el Tipo de Acceso
    type LucideIcon,
} from "lucide-react";
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const response = await portalService.crearPortal({
                ...
                iconoPortal:
                    modoVisual === "icono" ? iconoSeleccionado : undefined,
                colorPortal:
                    modoVisual === "icono" ? colorSeleccionado : undefined,
                logoUrl: undefined,
            });
            ...
            if (modoVisual === "imagen" && imagenFile) {
                ...
                const imgRes = await apiClient.patch(
                    `/portales/${response.id}/imagen`,
                    formData,
                    {
                        headers: { "Content-Type": "multipart/form-data" },
                    },
                );
                await adminService.actualizarPortal(response.id, {
                    logoUrl: imgRes.data.logoUrl,
                });
            }
            ...
            if (
                ...
                mensaje.includes("Ya existe un portal")
            ) {
                setErrorDuplicado(
                ...
                showToast(
                    "Ocurrió un error al crear el portal. Intentá de nuevo.",
                    "error",
                );
            }
        } finally {
            ...
            <div className="bg-surface-container-lowest p-8 rounded-sm">
                <div className="mb-8">
                    ...
                    <p className="text-muted-foreground">
                        Completá los datos para crear el portal de tu carrera.
                        El nombre de la carrera y la universidad son
                        obligatorios.
                    </p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <section className="space-y-4">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-muted-foreground mb-2">
                                Ayuda a distinguir tu portal en búsquedas. Ej:
                        ...
                        <div>
                            ...
                            <p className="text-xs text-muted-foreground mb-2">
                                Se muestra en las cards de búsqueda. Máximo 300
                                caracteres.
                            </p>
                            <textarea
                                id="descripcion"
                    ...
                    >
                        ...
                        <p className="text-sm text-muted-foreground">
                            Determiná cómo se unirán los estudiantes a tu
                            portal.
                        </p>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            >
                                ...
                                <p className="text-xs text-muted-foreground ml-[44px]">
                                    Cualquier estudiante podrá unirse
                                    automáticamente al portal de la carrera.
                                </p>
                            </button>
                            ...
                            >
                                ...
                                <p className="text-xs text-muted-foreground ml-[44px]">
                                    Los estudiantes enviarán una solicitud que
                                    requerirá tu aprobación.
                                </p>
                            </button>
                        </div>
                    </section>
                                    ...
                                    <div className="grid grid-cols-6 gap-2">
                                        ...
                                        {iconosFiltrados.length === 0 && (
                                            <p className="col-span-6 text-sm text-muted-foreground text-center py-4">
                                                No hay íconos que coincidan con
                                                "{busquedaIcono}".
                                            </p>
                                        )}
                                    </div>
                            ...
                            <div>
                                ...
                                {imagenPreviewUrl ? (
                                    ...
                                    <button
                                        ...
                                        style={{
                                            borderColor:
                                                "rgba(169, 180, 185, 0.3)",
                                        }}
                                    >
                                        <Upload className="w-6 h-6" />
                                        <span className="text-sm">
                                            Hacé click para elegir una imagen
                                        </span>
                                ...
                                <p className="text-xs text-muted-foreground mt-2">
                                    La subida a Cloudinary se implementa
                                    próximamente. Por ahora el portal se crea
                                    sin imagen.
                                </p>
                            </div>
                        )}
